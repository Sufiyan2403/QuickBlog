        ...
        <div className='flex flex-col items-center justify-center'>
            ...
            <form onSubmit={handleSubmit} className='mt-6 w-full sm:max-w-md text-gray-600'>
              ...
              <div className='flex flex-col'>
                ...
                <input onChange={e=>setPassword(e.target.value)} value={password} type="password" required placeholder='your passowrd' className='border-b-2 border-gray-300 p-2 outline-none mb-6'/>
              </div>
